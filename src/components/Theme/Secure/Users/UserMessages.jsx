...
class UserMessages extends Component {
  ...
  componentDidMount() {
    ...
    document.title = "User Messages - Wittyflow";
    ...
    this.setState({ loading: true,userId:userId,clientName:clientName });

    get(`secure/users/${userId}/messages?start_date=${startdate}&end_date=${enddate}`)
      .then(res => {
        ...
        <div className="kt-portlet kt-portlet--mobile">
          <div className="kt-portlet__head kt-portlet__head--lg">
            <div className="kt-portlet__head-label">
             ...
             <h3 className="kt-portlet__head-title">SMS Overview - {clientName}</h3>
            </div>
          </div>
...
export default connect(null, { signOut })(UserMessages);
