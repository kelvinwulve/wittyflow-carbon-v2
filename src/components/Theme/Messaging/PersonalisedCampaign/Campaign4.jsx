            ...
            return (
                ...
                <Modal show={data.show_preview} onHide={this.props.handleClosePreview}>
                    <Modal.Header closeButton>
                        <Modal.Title>Add preview receipient's contact</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                           <div className="form-group">
                               <label htmlFor="receipients">Contact</label>
                               <textarea name="contact" value={contact.join(',')} onChange={this.handleChange} id="" cols="30" rows="10" className="form-control"></textarea>
                               <p className="pull-right">{length} contacts</p>
                           </div>                         
                    </Modal.Body>
                    <Modal.Footer>
                        {data.previewing? <Spinner /> :<button className="btn btn-block btn-primary" onClick={()=>this.props.handlePreview(contact)}>Preview</button>}
                    </Modal.Footer>
                </Modal>
                </>
            )
